...
import './coverPhotoUploadDialog.css';

export default function CoverPhotoUploadDialog({ open, user, handleClose}) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (photo) {
            ...
            try {
                await axios.put("https://node-social-backend-1990.herokuapp.com/api/users/" + user._id, {userId: user._id, coverPicture: fileName });
    ...
    return (
        <div>
            <Dialog 
                ...
                maxWidth="sm"
            >
                <DialogTitle id="form-dialog-title">Upload Cover Photo</DialogTitle>
                <DialogContent>
